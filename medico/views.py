...
def consulta_area_medico(request, id_consulta):
    ...
    if request.method == 'GET':
        ...
        if consulta.status == 'C':
            messages.add_message(request, constants.WARNING, 'Esta consulta já foi canceldada, você não pode inicia-la')
            return redirect(f'/medicos/consulta-area-medico/{id_consulta}')
        elif consulta.status == 'F':
            messages.add_message(request, constants.WARNING, 'Esta consulta já foi finalizada, você não pode inicia-la')
            return redirect(f'/medicos/consulta-area-medico/{id_consulta}')
